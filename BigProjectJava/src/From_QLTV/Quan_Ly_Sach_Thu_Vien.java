...
public class Quan_Ly_Sach_Thu_Vien extends javax.swing.JFrame {
    public static Form_Dang_Nhap lgForm = new Form_Dang_Nhap();
    ...
    private void initComponents() {
        ...
        jLabel16.setText("kệ A1");

        jLabel17.setText("Kệ A2");

        jLabel18.setText("Kệ A3");

        jLabel29.setText("Kệ A4");
    ...
    private void btnThoatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThoatActionPerformed
        if(JOptionPane.showConfirmDialog(this, "Bạn có muốn thoát không?", "Thông báo", JOptionPane.YES_OPTION)
